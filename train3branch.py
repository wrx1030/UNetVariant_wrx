...
from model import threeBnewUNet

from torch.utils.tensorboard import SummaryWriter
from utils.dataset_tb import BasicDataset
...
dir_img = 'D:/DataSet/3Dircadb/prev+next/CT/'
dir_mask = 'D:/DataSet/3Dircadb/prev+next/GT/'
dir_previous = 'D:/DataSet/3Dircadb/prev+next/CTprev/'
dir_next = 'D:/DataSet/3Dircadb/prev+next/CTnext/'
...
def train_net(net,
    ...
    dataset = BasicDataset(dir_img, dir_mask, dir_previous, dir_next, img_scale)
    ...
    if Resume_train:
        path_checkpoint = "./checkpoints/3Dircadb_3branchECA_epoch20.pth"  # 断点路径
    ...
    for epoch in range(start_epoch + 1, start_epoch + epochs + 1):  # 继续训练
        ...
        if save_cp and (epoch+1) % 10 == 0:  # 保存节点频率调整
            ...
            torch.save(checkpoint,
                       dir_checkpoint + f'3Dircadb_3branchECA_epoch{epoch + 1}.pth')  # 记得改名
...
if __name__ == '__main__':
    ...
    net = threeBnewUNet(n_channels=1, n_classes=1)
